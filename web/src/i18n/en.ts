...
const en = {
  ...
  auth: {
    ...
    verifySubtitle: 'We sent a 6-digit code to <bold>{{name}}</bold>.',
    verifyAction: 'Verify',
    resend: 'Resend code',
    ...
    invitePlaceholder: 'Paste the code from your invitation link',
    inviteRequired: 'This server is invite-only. Ask an admin for an invitation link.',
    inviteValid: 'Invitation accepted',
    inviteChecking: 'Checking invitation…',
    inviteUnknown: "We don't recognise that invitation code",
    inviteUsed: 'That invitation has already been used',
    inviteRevoked: 'That invitation has been withdrawn',
    inviteExpired: 'That invitation has expired',
  },
  dashboard: {
  ...
  profile: {
    ...
    lockScreen: 'What notifications show',
    lockScreenHint:
      'Your device decrypts messages itself. The server only ever holds encrypted text and cannot read your messages whichever option you pick.',
    previewMessage: 'The message',
    previewMessageHint: 'Sender, picture, and what they said.',
    previewSender: 'Just who sent it',
    previewSenderHint: 'Their name and picture, but not the message.',
    previewGeneric: 'Nothing',
    previewGenericHint: 'Only that a message arrived. Best for a shared or overlooked screen.',
  ...
  call: {
    ...
    unmute: 'Unmute',
    muted: 'Muted',
    audioSettings: 'Audio devices',
    microphone: 'Microphone',
    speaker: 'Speaker',
    eventMissedIn: 'Missed call',
    eventMissedOut: 'No answer',
    eventDeclinedIn: 'Call declined',
    eventDeclinedOut: 'Call declined',
    eventFailed: 'Call failed to connect',
    status: {
      calling: 'Calling…',
      ringing: 'Ringing…',
  ...
  security: {
    menuItem: 'Devices & security',
    title: 'Devices & security',
    devicesHeading: 'Your devices',
    thisDevice: 'This device',
    lastActive: 'Active {{when}}',
    noDevices: 'No devices found',
    statusHeading: 'End-to-end encryption',
    backupOn: 'Chats backed up',
    backupOff: 'Chats are not backed up yet',
    backupFailing: "Backup is failing — new messages exist only in this browser.",
    backupPending: "Backing up {{count}} message(s)…",
    backupNow: "Back up now",
    backupNowDone: "Everything in this browser is backed up.",
    backupNowFailed: "Could not back up. Nothing was lost — your messages are still here.",
    backupDormant: "This browser isn't backing up",
    backupDormantHint: "A backup exists, but it was made elsewhere. Nothing you read or write here is being added to it until you enter your recovery code.",
    unlockLabel: "Recovery code",
    unlock: "Unlock",
    unlockDone: "This browser is backing up again.",
    unlockFailed: "That code doesn't open the backup.",
    backupOnHint: 'Your history can be restored on a new device with your recovery code.',
    backupOffHint: 'Set a recovery code so your history can be restored on a new device.',
    syncOn: 'History syncs to new devices automatically when another device is online.',
  ...
  channel: {
    ...
    subscribers: {
      ...
      unban: 'Unban',
      remove: 'Remove',
      removeConfirm: 'Remove <bold>{{name}}</bold> from this channel? Their devices stop receiving notifications.',
  ...
  admin: {
    ...
    navInvites: 'Invites',
    title: 'Admin panel',
    inviteHeader: 'Invitations',
    inviteNew: 'New invitation',
    inviteNote: 'Note',
    inviteNotePlaceholder: 'Who is this for?',
    inviteExpiry: 'Expires after',
    inviteNeverExpires: 'Never',
    inviteDays: '{{count}} days',
    inviteCreate: 'Create invitation',
    inviteCreated: 'Invitation created',
    inviteCreateFailed: 'Could not create the invitation',
    inviteLink: 'Invitation link',
    inviteLinkWeb: 'For a browser',
    inviteLinkApp: 'For the mobile app',
    inviteLinkAppHint:
      'Opens Pheme directly and points it at this server. Only works on a device with the app installed.',
    inviteCopyOnce:
      'Copy this link now — it is shown once and cannot be recovered. Losing it means issuing a new invitation.',
    inviteCopy: 'Copy link',
    inviteCopied: 'Link copied',
    inviteRevoke: 'Revoke',
    inviteRevokeConfirm: 'Revoke this invitation? Whoever holds the link will no longer be able to register.',
    inviteRevoked: 'Invitation revoked',
    inviteRevokeFailed: 'Could not revoke the invitation',
    inviteSearch: 'Search by note or code prefix',
    inviteNone: 'No invitations yet.',
    inviteColCode: 'Code',
    inviteColNote: 'Note',
    inviteColStatus: 'Status',
    inviteColCreated: 'Created',
    inviteColExpires: 'Expires',
    inviteColUsedBy: 'Used by',
    inviteStatusPending: 'unused',
    inviteStatusUsed: 'used',
    inviteStatusRevoked: 'revoked',
    inviteStatusExpired: 'expired',
    inviteOpenRegistration:
      'This server currently allows open registration, so invitations are not required. Set PHEME_INVITE_ONLY=true to close it.',
    ...
    you: 'you',
    deleteUserConfirm:
      'Delete user <bold>{{name}}</bold>? This removes the user and all their channels, keys, subscriptions and messages. This cannot be undone.',
    ...
    resetPasswordConfirm: 'Set a new password for <bold>{{name}}</bold>.',
    ...
    colMessage: 'Message',
    colComment: 'Comment',
    deleteCommentConfirm: 'Delete this comment by <bold>{{name}}</bold>? This cannot be undone.',
    commentDeleted: 'Comment deleted',
    banAuthor: 'Ban author',
    banAuthorConfirm: 'Block <bold>{{name}}</bold>? They will be unable to sign in or post.',
