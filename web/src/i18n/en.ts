...
const en = {
  common: {
    ...
    navProfile: "Profile",
    notificationsOff:
      "Notifications are off — you won’t be alerted about new messages.",
    menu: "Menu",
  ...
  dashboard: {
    ...
    addChannelRefHint:
      "Enter a channel’s Trigger ID or its @phetag to subscribe.",
    add: "Subscribe",
    joined: "Subscribed",
  ...
  backup: {
    ...
    alreadySetUp:
      "Encryption was already set up on this device in another window. Reloading.",
  },
  recovery: {
    ...
    viewDescription:
      "Keep this somewhere safe. It restores your chat history on a new device.",
    notOnThisDevice:
    ...
    codeHint:
      "You can also enter a recovery passphrase if you set one instead.",
  },
  security: {
  ...
  channel: {
    ...
    deleteMessageConfirm:
      "Delete this message? Its images and comments go with it. This cannot be undone.",
    ...
    phetagHint:
      "2–24 characters: letters, digits, “.”, “-”, “_”. Cannot start with a digit, “.” or “-”.",
    phetagSaved: "Phetag updated",
    phetagNone: "No phetag set",
    shareTitle: "Share this channel",
    shareDescription:
      "Others can add this channel with its Trigger ID or phetag, or by scanning this QR code.",
    leaveTitle: "Leave channel",
    leaveDescription:
      "Stop receiving notifications and remove this channel from your list.",
    leave: "Leave channel",
    leaveConfirm:
      "Leave <bold>{{name}}</bold>? You can re-join later with its Trigger ID or phetag.",
    ...
    subscribers: {
      ...
      remove: "Remove",
      removeConfirm:
        "Remove <bold>{{email}}</bold> from this channel? Their devices stop receiving notifications.",
    ...
    subscribeDescription:
      "Receive push notifications from this channel in this browser.",
  ...
  admin: {
    ...
    deleteCommentConfirm:
      "Delete this comment by <bold>{{email}}</bold>? This cannot be undone.",
    commentDeleted: "Comment deleted",
    banAuthor: "Ban author",
    banAuthorConfirm:
      "Block <bold>{{email}}</bold>? They will be unable to sign in or post.",
