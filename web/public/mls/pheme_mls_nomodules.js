let wasm_bindgen = (function(exports) {
    ...
    exports.MlsPreviewClient = MlsPreviewClient;
     ...
     * @returns {Uint8Array}
     */
    function decryptBackup(passphrase, salt, nonce, ciphertext) {
     ...
     * @returns {BackupBlob}
     */
    function encryptBackup(passphrase, plaintext) {
        const ptr0 = passArray8ToWasm0(passphrase, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(plaintext, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
