...
const Map<String, String> ruStrings = {
  ...
  'backup.statusSafe': 'Всё здесь сохранено в резервной копии. Потеря телефона не приведёт к потере этих сообщений.',
  'backup.statusPending': 'Сохраняем новые сообщения…',
  'backup.statusPendingCount': '{count} ещё не на сервере — они есть только на этом телефоне.',
  'backup.statusFailing': 'Резервное копирование не работает. Новые сообщения есть только на этом телефоне.',
  'backup.statusNone': 'Кода восстановления нет, поэтому ничего не сохраняется. Потеряете телефон — потеряете эти сообщения.',
