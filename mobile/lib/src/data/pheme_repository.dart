...
class PhemeRepository {
  ...
  /// The history offers waiting in a conversation, newest first.
  ///
  /// An offer is protocol traffic and is therefore absent from the transcript, so it used to arrive
